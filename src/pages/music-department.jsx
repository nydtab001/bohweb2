...
function MusicDep() {
  return (
    ...
    <PageHeader
    />
    <SectionHeading title="Music Department" bg="bg-sky-800" colour="text-slate-300"/>
    <Section>
      <MinistryLayout image={logos[14].src} director={{ name: "John Doe", photo: "/images/john_doe.jpg" }}>
        <div>
